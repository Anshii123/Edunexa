  ...
  return (
    <div className="min-h-screen bg-[#F8F7F4] py-16 lg:py-24 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="bg-white rounded-3xl p-4 sm:p-6 border border-black/[0.08] shadow-card">
          <div className="flex items-center gap-2 text-indigo-600 font-bold text-sm mb-4 px-2 font-display">
            <Video className="w-4 h-4 text-indigo-600" />
            <span>Campus Video Tour: Daily Student Life & Facilities</span>
          </div>
          <div className="relative aspect-video max-h-[520px] w-full rounded-2xl overflow-hidden bg-navy-950">
            <video
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold text-navy-900 font-display tracking-tight">Infrastructure Gallery</h2>
            <span className="text-xs text-charcoal-500 font-mono">Click any image to expand</span>
          </div>
          <CampusMediaGallery />
        </div>
      </div>
